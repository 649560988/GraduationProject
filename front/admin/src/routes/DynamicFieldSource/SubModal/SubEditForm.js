        ...
        <Modal title='修改子数据' visible maskClosable={false}
          ...
          <Form type='vertical'>
            <FormItem label='子数据编码'>
              {getFieldDecorator('sourceSubCode', {
                ...
                initialValue: this.props.selectedItem.sourceSubCode.toString()
              })(
                <Input placeholder='子数据编码' autoComplete='off' />
              )}
            </FormItem>
            <FormItem label='子数据名称'>
              {getFieldDecorator('sourceSubName', {
                rules: [{
                  required: true,
                  message: '子数据名称不能为空',
                  whitespace: true
                ...
                initialValue: this.props.selectedItem.sourceSubName
              })(
