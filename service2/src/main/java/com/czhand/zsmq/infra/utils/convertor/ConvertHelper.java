...
public class ConvertHelper {
    ...
    public static <T> List<T> convertList(final List listSource, Class<T> destin) {
        ...
        for (Object object : listSource) {
            T t = invokeConvertByBeanUtils(object, destin);
            list.add(t);
        }
...
//        final DestinClassData destinClassData = getDestinClassData(source, destin);
    ...
    public static <T> T convert(final Object obj, Class<T> destin) {
        return invokeConvertByBeanUtils(obj,destin);
//        if (obj == null) {
//            return null;
//        }
...
//        return invokeConvert(destinClassData, obj);
    ...
    static <T> T invokeConvertByBeanUtils(Object source ,Class<T> destin){
        T t = null;
        try {
            t = destin.newInstance();
        } catch (Throwable e){
            throw new RuntimeException(destin+"该类无默认构造函数");
        }
